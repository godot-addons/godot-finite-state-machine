...
var m_target : Object = null setget set_target
...
func set_target(new_target):
	...
	"""
	for s in m_states:
		m_states[s].m_target = new_target
...
func set_state(p_state_id: String, p_state: State) -> void:
	...
	p_state.m_state_machine = self

	if m_target:
		p_state.set_target(m_target)
...
class State extends Resource:
	...
	var m_state_machine: StateMachine
